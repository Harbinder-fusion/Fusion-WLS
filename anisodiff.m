...
%Function to perform anisotropic diffusion of an image following Perona and
%Malik's algorithm. This process smoothes regions while preserving, and enhancing, the contrast at sharp intensity gradients.
